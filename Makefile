APP_NAME        = Brightness Overclock
EXECUTABLE_NAME = BrightnessOverclock
...
app: build
	rm -rf "$(APP_BUNDLE)" "build/$(EXECUTABLE_NAME).app"
...
install: app
	...
	rm -rf "/Applications/$(APP_NAME).app" "/Applications/$(EXECUTABLE_NAME).app"
